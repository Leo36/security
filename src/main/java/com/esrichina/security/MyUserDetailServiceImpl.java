package com.esrichina.security;
...
import com.esrichina.dao.ResourcesDao;
...
//		System.err.println("-----------MyUserDetailServiceImpl loadUserByUsername ----------- ");
		...
		//取得用户的权限
		com.esrichina.entity.User users = userDao.querySingleUser(username);
		if  (users==null)  
	...
	// 取得用户的权限
	private Set<GrantedAuthority> obtionGrantedAuthorities(com.esrichina.entity.User user) {
